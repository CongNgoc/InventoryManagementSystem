...
CREATE TABLE HISTORY(
  HISTORY_ID NUMBER(5) NOT NULL PRIMARY KEY,
...
insert into menu(MENU_ID, parent_id,url,menu_name,order_index) values (3, 0,'/management','Qu·∫£n l√Ω',3);

insert into menu(MENU_ID, parent_id,url,menu_name,order_index) values (4, 1,'/product-info/list','Danh s√°ch s·∫£n ph·∫©m',2);
insert into menu(parent_id,url,menu_name,order_index) values (1,'/category/list','Danh s√°ch category',1);
insert into menu(parent_id,url,menu_name,order_index) values (1,'/category/edit','S·ª≠a',-1);
insert into menu(parent_id,url,menu_name,order_index) values (1,'/category/view','Xem',-1);
insert into menu(parent_id,url,menu_name,order_index) values (1,'/category/add','Th√™m m·ªõi',-1);
insert into menu(parent_id,url,menu_name,order_index) values (1,'/category/save','L∆∞u',-1);
insert into menu(parent_id,url,menu_name,order_index) values (1,'/category/delete','Xo√°',-1);

insert into menu(parent_id,url,menu_name,order_index) values (2,'/goods-recept/list','Danh s√°ch nh·∫≠p kho',1);
insert into menu(parent_id,url,menu_name,order_index) values (2,'/goods-issue/list','Danh s√°ch xu·∫•t kho',2);
insert into menu(parent_id,url,menu_name,order_index) values (2,'/product-in-stock/list','S·∫£n ph·∫©m trong kho',3);
insert into menu(parent_id,url,menu_name,order_index) values (2,'/history','L·ªãch s·ª≠ kho',4);
...
--MODIFY DATE: 17/06/2020
--MODIFY BY: NGUYEN NGOC CONG
--add column imgUrl to ProductInfo table
ALTER TABLE PRODUCT_INFO
ADD IMG_URL VARCHAR2(300);

INSERT INTO PRODUCT_INFO(CATEGORY_ID, NAME, DESCRIPTION, CODE) VALUES(42, 'B·nh plan', 'B·nh plan nguyÍn ch?t', 'A2376');
INSERT INTO PRODUCT_INFO(CATEGORY_ID, NAME, DESCRIPTION, CODE) VALUES(42, 'B·nh plan tr?ng mu?i', 'B·nh plan nguyÍn ch?t', 'A21376');

--MODIFY DATE: 22/06/2020
--MODIFY BY: NGUYEN NGOC CONG
--add column PRICE to ProductInfo table
ALTER TABLE PRODUCT_INFO
ADD PRICE NUMBER(15, 0);
COMMIT;
